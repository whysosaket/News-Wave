...
const Hero = () => {
  return (
    <section>
      <div className="bg-black text-white md:py-20">
        <div className="container mx-auto flex flex-col md:flex-row items-center md:my-24">
          <div className="flex flex-col w-full lg:w-1/3 justify-center items-center md:items-start p-8">
            ...
            className="font-space text-5xl md:text-5xl text-yellow-300 tracking-loose">
              NewsWave
            </motion.h1>
            <motion.h2
            initial={{x: -200, opacity: 0}}
            ...
            className="font-inter text-center md:text-start text-2xl md:text-4xl mt-2 md:leading-snug mb-2">
            ...
            className="text-sm text-center md:text-start md:text-base text-gray-50 mb-4">
          ...
          <div className="p-4 md:p-8 mb-32 md:mb-0 md:mt-0 ml-0 md:ml-12 lg:w-2/3  justify-center">
